...
pub trait SupportGenerator: Clone + Debug {
    ...
    ///
    /// Called with the support generated by [`SupportGenerator::support`].
...
pub trait SupportValue: Clone + Debug {
    /// Returns `true` if `self` is in the given domain.
...
/// A trait to identify types that can serve as variables in a support.
