...
fn cumulative_time_table_lower_bound_2() {
    let (solver, _, variables) = set_up_cumulative_state(&[((0, 6), 8, 6), ((-3, 17), 10, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_12() {
    let (solver, _, variables) = set_up_cumulative_state(&[((18, 22), 8, 8), ((21, 51), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_13() {
    let (solver, _, variables) = set_up_cumulative_state(&[((8, 8), 10, 8), ((7, 146), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_86() {
    let (solver, _, variables) = set_up_cumulative_state(&[((53, 56), 4, 9), ((55, 60), 2, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_103() {
    let (solver, _, variables) = set_up_cumulative_state(&[((0, 8), 10, 8), ((6, 95), 3, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_222() {
    let (solver, _, variables) = set_up_cumulative_state(&[((0, 3), 8, 7), ((-4, 93), 8, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_163() {
    let (solver, _, variables) = set_up_cumulative_state(&[((8, 8), 10, 8), ((7, 24), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_195() {
    let (solver, _, variables) = set_up_cumulative_state(&[((8, 8), 10, 8), ((7, 19), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_206() {
    let (solver, _, variables) = set_up_cumulative_state(&[((70, 71), 8, 7), ((67, 86), 5, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_211() {
    let (solver, _, variables) = set_up_cumulative_state(&[((22, 23), 4, 7), ((22, 90), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_260() {
    let (solver, _, variables) = set_up_cumulative_state(&[((53, 57), 8, 7), ((53, 68), 5, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_271() {
    let (solver, _, variables) = set_up_cumulative_state(&[((78, 78), 2, 9), ((74, 86), 5, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_273() {
    let (solver, _, variables) = set_up_cumulative_state(&[((0, 7), 8, 6), ((-2, 52), 10, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1025() {
    let (solver, _, variables) = set_up_cumulative_state(&[((22, 24), 8, 8), ((23, 53), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1170() {
    let (solver, _, variables) = set_up_cumulative_state(&[((8, 15), 10, 8), ((8, 50), 8, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1093() {
    let (solver, _, variables) = set_up_cumulative_state(&[((25, 28), 4, 9), ((27, 51), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1182() {
    let (solver, _, variables) = set_up_cumulative_state(&[((41, 46), 8, 8), ((44, 64), 3, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1259() {
    let (solver, _, variables) = set_up_cumulative_state(&[((29, 30), 3, 7), ((28, 48), 3, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1248() {
    let (solver, _, variables) = set_up_cumulative_state(&[((42, 45), 8, 8), ((43, 64), 3, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1423() {
    let (solver, _, variables) = set_up_cumulative_state(&[((29, 29), 3, 9), ((27, 64), 3, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1448() {
    let (solver, _, variables) = set_up_cumulative_state(&[((35, 38), 8, 8), ((37, 51), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1454() {
    let (solver, _, variables) = set_up_cumulative_state(&[((42, 46), 7, 6), ((44, 64), 3, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1571() {
    let (solver, _, variables) = set_up_cumulative_state(&[((25, 28), 4, 7), ((26, 30), 3, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_lower_bound_1528() {
    let (solver, _, variables) = set_up_cumulative_state(&[((34, 38), 8, 8), ((35, 51), 4, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_175() {
    let (solver, _, variables) = set_up_cumulative_state(&[((71, 71), 3, 9), ((48, 73), 7, 6)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_154() {
    let (solver, _, variables) = set_up_cumulative_state(&[((6, 8), 10, 8), ((0, 15), 8, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_262() {
    let (solver, _, variables) = set_up_cumulative_state(&[((86, 86), 8, 8), ((46, 93), 4, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_244() {
    let (solver, _, variables) = set_up_cumulative_state(&[((93, 94), 2, 8), ((39, 94), 3, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_347() {
    let (solver, _, variables) = set_up_cumulative_state(&[((86, 86), 8, 8), ((26, 93), 4, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_433() {
    let (solver, _, variables) = set_up_cumulative_state(&[((72, 72), 8, 8), ((59, 79), 3, 9)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_435() {
    let (solver, _, variables) = set_up_cumulative_state(&[((82, 82), 3, 9), ((0, 84), 8, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_293() {
    let (solver, _, variables) = set_up_cumulative_state(&[((5, 9), 10, 8), ((0, 14), 8, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_374() {
    let (solver, _, variables) = set_up_cumulative_state(&[((22, 23), 4, 7), ((18, 25), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_383() {
    let (solver, _, variables) = set_up_cumulative_state(&[((78, 78), 2, 9), ((56, 79), 5, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_389() {
    let (solver, _, variables) = set_up_cumulative_state(&[((8, 9), 10, 8), ((0, 17), 8, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_720() {
    let (solver, _, variables) = set_up_cumulative_state(&[((21, 24), 8, 7), ((21, 28), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_866() {
    let (solver, _, variables) = set_up_cumulative_state(&[((20, 25), 8, 7), ((21, 27), 4, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_882() {
    let (solver, _, variables) = set_up_cumulative_state(&[((29, 31), 3, 7), ((18, 31), 8, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_912() {
    let (solver, _, variables) = set_up_cumulative_state(&[((28, 29), 3, 7), ((20, 30), 4, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1110() {
    let (solver, _, variables) = set_up_cumulative_state(&[((46, 47), 2, 8), ((45, 47), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_961() {
    let (solver, _, variables) = set_up_cumulative_state(&[((27, 27), 5, 6), ((8, 31), 10, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1014() {
    let (solver, _, variables) = set_up_cumulative_state(&[((13, 13), 10, 8), ((0, 22), 8, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1188() {
    let (solver, _, variables) = set_up_cumulative_state(&[((51, 51), 4, 9), ((41, 54), 7, 6)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1288() {
    let (solver, _, variables) = set_up_cumulative_state(&[((24, 27), 8, 7), ((21, 31), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1350() {
    let (solver, _, variables) = set_up_cumulative_state(&[((7, 14), 10, 8), ((8, 16), 3, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1401() {
    let (solver, _, variables) = set_up_cumulative_state(&[((29, 29), 3, 7), ((25, 31), 4, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1451() {
    let (solver, _, variables) = set_up_cumulative_state(&[((4, 8), 10, 8), ((0, 13), 8, 6)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1480() {
    let (solver, _, variables) = set_up_cumulative_state(&[((38, 43), 8, 7), ((26, 45), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1880() {
    let (solver, _, variables) = set_up_cumulative_state(&[((51, 51), 2, 8), ((26, 52), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1542() {
    let (solver, _, variables) = set_up_cumulative_state(&[((38, 45), 8, 7), ((31, 45), 3, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_2081() {
    let (solver, _, variables) = set_up_cumulative_state(&[((21, 23), 4, 9), ((8, 24), 3, 10)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1619() {
    let (solver, _, variables) = set_up_cumulative_state(&[((38, 45), 8, 7), ((8, 45), 2, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_2339() {
    let (solver, _, variables) = set_up_cumulative_state(&[((36, 38), 3, 9), ((36, 38), 2, 8)], 14); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1796() {
    let (solver, _, variables) = set_up_cumulative_state(&[((31, 31), 3, 7), ((18, 33), 4, 7)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1797() {
    let (solver, _, variables) = set_up_cumulative_state(&[((18, 18), 3, 6), ((8, 20), 10, 8)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1904() {
    let (solver, _, variables) = set_up_cumulative_state(&[((52, 55), 7, 6), ((34, 58), 2, 9)], 13); // It could be the case that a conflict is returned
...
fn cumulative_time_table_upper_bound_1908() {
    let (solver, _, variables) = set_up_cumulative_state(&[((43, 45), 3, 7), ((10, 45), 8, 7)], 13); // It could be the case that a conflict is returned
