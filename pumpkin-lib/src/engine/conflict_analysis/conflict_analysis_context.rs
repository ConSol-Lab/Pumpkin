...
impl<'a> ConflictAnalysisNogoodContext<'a> {
    ...
    pub(crate) fn get_propagation_reason_simple(&mut self, predicate: Predicate) -> Vec<Predicate> {
        // probably this function should go into the assignments
            ...
            match trail_entry.predicate {
                    ...
                    match predicate {
                        Predicate::LowerBound {
                            ...
                            // bound. This means the reason is due to holes in the domain.
                                ...
                                vec![one_less_bound_predicate, not_equals_predicate]
                            }
                        }
                        Predicate::UpperBound {
                            domain_id: _,
                ...
                Predicate::UpperBound {
                    ...
                    Predicate::UpperBound {
                        ...
                        if trail_upper_bound < input_upper_bound {
                            ...
                            vec![new_ub_predicate, not_equal_predicate]
                        }
                    }
                    Predicate::NotEqual {
                        domain_id: _,
                ...
                Predicate::NotEqual {
                    ...
                    Predicate::LowerBound {
                        ...
                        vec![new_lb_predicate, new_not_equals_predicate]
                    }
                    Predicate::UpperBound {
                        domain_id,
                        upper_bound: input_upper_bound,
                        ...
                        vec![new_ub_predicate, new_not_equals_predicate]
                    }
                    Predicate::NotEqual {
                        domain_id: _,
                        not_equal_constant: _,
