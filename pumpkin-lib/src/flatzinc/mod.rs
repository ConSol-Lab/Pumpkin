...
use crate::branching::branchers::alternating_brancher::AlternatingBrancher;
use crate::branching::branchers::alternating_brancher::AlternatingStrategy;
...
use crate::termination::OsSignal;
...
#[allow(dead_code)]
pub(crate) fn create_solver_from_mzn(instance: impl AsRef<Path>) -> Result<Solver, FlatZincError> {
    let instance = File::open(instance)?;

    let mut solver = Solver::default();
    let _ = parse_and_compile(&mut solver, instance, FlatZincOptions::default())?;
