use log::warn;
use pumpkin_branchers::value_selection::DynamicValueSelector;
use pumpkin_branchers::value_selection::InDomainInterval;
use pumpkin_branchers::value_selection::InDomainMax;
use pumpkin_branchers::value_selection::InDomainMedian;
use pumpkin_branchers::value_selection::InDomainMiddle;
use pumpkin_branchers::value_selection::InDomainMin;
use pumpkin_branchers::value_selection::InDomainRandom;
use pumpkin_branchers::value_selection::InDomainSplit;
use pumpkin_branchers::value_selection::InDomainSplitRandom;
use pumpkin_branchers::value_selection::OutDomainMax;
use pumpkin_branchers::value_selection::OutDomainMedian;
use pumpkin_branchers::value_selection::OutDomainMin;
use pumpkin_branchers::value_selection::OutDomainRandom;
use pumpkin_branchers::value_selection::ReverseInDomainSplit;
use pumpkin_branchers::variable_selection::AntiFirstFail;
use pumpkin_branchers::variable_selection::DynamicVariableSelector;
use pumpkin_branchers::variable_selection::FirstFail;
use pumpkin_branchers::variable_selection::InputOrder;
use pumpkin_branchers::variable_selection::Largest;
use pumpkin_branchers::variable_selection::MaxRegret;
use pumpkin_branchers::variable_selection::Smallest;
