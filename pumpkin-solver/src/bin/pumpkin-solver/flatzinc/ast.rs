use log::warn;
use pumpkin_core::branching::value_selection::DynamicValueSelector;
use pumpkin_core::branching::value_selection::InDomainInterval;
use pumpkin_core::branching::value_selection::InDomainMax;
use pumpkin_core::branching::value_selection::InDomainMedian;
use pumpkin_core::branching::value_selection::InDomainMiddle;
use pumpkin_core::branching::value_selection::InDomainMin;
use pumpkin_core::branching::value_selection::InDomainRandom;
use pumpkin_core::branching::value_selection::InDomainSplit;
use pumpkin_core::branching::value_selection::InDomainSplitRandom;
use pumpkin_core::branching::value_selection::OutDomainMax;
use pumpkin_core::branching::value_selection::OutDomainMedian;
use pumpkin_core::branching::value_selection::OutDomainMin;
use pumpkin_core::branching::value_selection::OutDomainRandom;
use pumpkin_core::branching::value_selection::ReverseInDomainSplit;
use pumpkin_core::branching::variable_selection::AntiFirstFail;
use pumpkin_core::branching::variable_selection::DynamicVariableSelector;
use pumpkin_core::branching::variable_selection::FirstFail;
use pumpkin_core::branching::variable_selection::InputOrder;
use pumpkin_core::branching::variable_selection::Largest;
use pumpkin_core::branching::variable_selection::MaxRegret;
use pumpkin_core::branching::variable_selection::Smallest;
